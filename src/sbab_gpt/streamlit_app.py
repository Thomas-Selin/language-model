...
# Add sidebar with explanations
with st.sidebar:
    st.header("Understanding Attention Visualizations")
    st.markdown("""
...
if st.button('Generate'):
    if user_input.strip():
        with st.spinner('Generating...'):
            result, mean_fig, max_fig, layer_figs = generate_text(user_input, max_new_tokens=max_tokens, temperature=temperature)
